                ...
                <div className="footer-bottom">
                    <div className="container">
                        <div className="text-center"> 
                            <span className="copyright-text">Copyright © 2024 <a href="https://techlife.ng/" target="_blank"  rel="noreferrer">Techlife Global Ventures Ltd</a>. All rights reserved.</span> 
                        </div>
                    </div>
                </div>
            </footer>  
