...
//images
import main from './../assets/images/aim/pic.png';
                        ...
                        <div className="row banner-inner">
                            <div className="col-lg-8 col-md-7">
                                <div className="banner-content">
                                    ...
                                    <p> Ahmad Ibrahim Muhammad is a passionate and forward-thinking professional, dedicated to leveraging his skills and qualifications for the betterment of society through impactful roles in governance and public service. With a deep commitment to progress and development, he consistently seeks avenues to expand his expertise and contribute to the collective growth of his community. Ahmad’s vision is rooted in driving immediate and sustainable change, guided by principles of transparency and innovation. His unwavering dedication to serving the public interest positions him as a key player in advancing political and social initiatives that foster inclusive development and prosperity.</p>
                                    ...
                                    <Link to={"/coming-soon"} className="btn btn-light"
                ...
                {/* <div className="content-inner-3 section-pattren1">
                    <div className="container">
                        <div className="section-head text-center wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <h2 className="title">We provide <br />  Support for Orphans and Vulnerable Children</h2>
                            <p>in Bauchi State.</p>
                        </div>
                        <CategoriesSlider />
                    </div>
